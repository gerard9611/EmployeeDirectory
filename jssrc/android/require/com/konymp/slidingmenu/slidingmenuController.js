define(function() {
    ...
    controller.Action14925129644515830 = function() {
        if (this.onProfileClick) {
            this.onProfileClick.apply(this, arguments);
        }
    }
    controller.Action14925129644983977 = function() {
        if (this.onFilterButtonClick) {
            this.onFilterButtonClick.apply(this, arguments);
        }
    }
    controller.Action14925129645449576 = function() {
