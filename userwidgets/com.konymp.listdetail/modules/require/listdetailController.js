define(function () {
    ...
    return {
        ...
        changeButtonSkinInDictionaryView: function (btnClicked) {
            try {
                konymp.logger.trace("----------Entering changeButtonSkinInDictionaryView Function---------", konymp.logger.FUNCTION_ENTRY);
            ...
            konymp.logger.trace("----------Exiting changeButtonSkinInDictionaryView Function---------", konymp.logger.FUNCTION_EXIT);
        },
        /**
        ...
        animateUserDetails: function () {
            try {
                ...
                for (var i = 0; i < this.media.length; i++) {
                    if (this.media[i].employee_id == manager_id && this.media[i].Media_name == "profile") {
                        this.view.flxImageReportingManagerHolder.isVisible = true;
                        this.view.imgReportingTo.base64 = this.media[i].Image;
                    }
                }
    ...
    */
    getData: function () {
        ...
        var filterData = [["Department", "", dept], ["Designation", "", desgn]];
        return filterData;
